...
- Version 4.* is compatible with PHPUnit 6.* and requires PHP versions 7.0 (or above).
	On HHVM there is a problem with PHPUnit 6.*, it won't install because HHVM can't satisfy PHP 7.0 requirement.

In latest version we are running our unit tests against PHP versions 5.6, 7 and against HHVM.
